sap.ui.define([
	...
	return BaseController.extend("ZZ1.ZZSOCIAL_MEDIA_EX.controller.CreateEntity", {
		...
		onSave: function () {
			...
			if (this._oViewModel.getProperty("/mode") === "edit") {
				...
				var requestMethod = this.setUseBatch("true") ? "batchRequestCompleted" : "requestCompleted";
				oModel.attachEventOnce(requestMethod, function (oEvent) {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("ZZ1_BPSOCIAL_ACC", {

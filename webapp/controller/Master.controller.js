...
sap.ui.define([
	...
	return BaseController.extend("ZZ1.ZZSOCIAL_MEDIA_EX.controller.Master", {

		formatter: formatter,
        _parent:BaseController.prototype,
		/* =========================================================== */
		/* lifecycle methods                                           */
		/* =========================================================== */
		...
		onSearch: function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("PartnerID", FilterOperator.Contains, sQuery)];
			} else {
				...
				function (mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							SAP_UUID: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("SAP_UUID"))
						}, true);
					}
				}.bind(this),
				function (mParams) {
		...
		_showDetail: function (oItem) {
			...
			this.getRouter().navTo("object", {
				SAP_UUID: encodeURIComponent(oItem.getBindingContext().getProperty("SAP_UUID"))
			}, bReplace);
		},
		...
		if(this.getParentObject(this))
		 return this.getParentObject(this).setUseBatch(useBatch);
		 return true;
		},
		/**

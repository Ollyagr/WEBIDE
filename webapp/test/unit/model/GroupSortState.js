sap.ui.define([
	"ZZ1/ZZSOCIAL_MEDIA_EX/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("PartnerID").length, 1, "The sorting by PartnerID returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by PartnerID and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("PartnerID");

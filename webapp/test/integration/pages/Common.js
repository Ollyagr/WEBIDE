sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("ZZ1/ZZSOCIAL_MEDIA_EX/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#SocialmediaAccount-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#SocialmediaAccount-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("ZZ1.ZZSOCIAL_MEDIA_EX.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ZZ1/ZZSOCIAL_MEDIA_EX/localService/mockserver"], function (mockserver) {

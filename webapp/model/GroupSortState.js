sap.ui.define([
	...
	return BaseObject.extend("ZZ1.ZZSOCIAL_MEDIA_EX.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias ZZ1.ZZSOCIAL_MEDIA_EX.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "PartnerID");
			}
